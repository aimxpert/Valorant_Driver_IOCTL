...
#define read_ctl CTL_CODE(FILE_DEVICE_UNKNOWN, 0x12AC, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define base_addy_ctl CTL_CODE(FILE_DEVICE_UNKNOWN, 0x13AC, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define cr3_van_ctl CTL_CODE(FILE_DEVICE_UNKNOWN, 0x14AC, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define write_ctl CTL_CODE(FILE_DEVICE_UNKNOWN, 0x15AC, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define code_move_mouse CTL_CODE(FILE_DEVICE_UNKNOWN, 0x16AC, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
NTSTATUS InitializeDriver(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath) {
    ...
    HideDriver(DriverObject); // hide from psloadedmodulelist
